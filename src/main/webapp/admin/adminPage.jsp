...
<div class="admin-layout">
    ...
    <div class="admin-content">
        ...
        <div class="stats-grid">
            <a href="<%=request.getContextPath()%>/admin/allProduct.jsp" class="stat-card" style="text-decoration: none; color: inherit;">
                <div class="stat-number"><%= dfCount.format(totalProducts) %></div>
                <div class="stat-label">전체 상품</div>
                <div class="stat-detail">전체 상품 보기</div>
            </a>
            <a href="<%=request.getContextPath()%>/admin/waittingProduct.jsp" class="stat-card" style="text-decoration: none; color: inherit;">
                <div class="stat-number"><%= dfCount.format(pendingCount) %></div>
                <div class="stat-label">승인 대기</div>
                <div class="stat-detail">대기 목록 보기</div>
            </a>
            <a href="<%=request.getContextPath()%>/admin/bidHistory.jsp" class="stat-card" style="text-decoration: none; color: inherit;">
                <div class="stat-number"><%= dfCount.format(totalBids) %></div>
                <div class="stat-label">전체 입찰 건수</div>
                <div class="stat-detail">입찰 내역</div>
            </a>
            <a href="<%=request.getContextPath()%>/admin/siteStatistics.jsp" class="stat-card" style="text-decoration: none; color: inherit;">
        ...
        <div class="content-section">
            ...
            <% if (pendingList.isEmpty()) { %>
                <div class="empty-state">
                    <i class="fas fa-clock"></i>
                    승인 대기 중인 상품이 없습니다.<br>
                    현재 승인 대기 중인 상품이 없습니다.
                </div>
            <% } else { %>
